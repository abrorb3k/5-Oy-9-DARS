...
const buttoncolors = document.querySelectorAll("#buttoncolor button");
buttoncolors &&
  buttoncolors.forEach(function (buttoncolo) {
    buttoncolo && buttoncolo.addEventListener("click", function () {
        let thiscolor = buttoncolo.style.backgroundColor
        text.style.color=thiscolor;
        nowcolor.textContent=`Hozirgi rang: ${thiscolor}`
        nowcolor.append(nowcolor)
      });
  });
